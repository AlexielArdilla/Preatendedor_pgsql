...
function confirmarBorrar() {
	return confirm("Está seguro que desea BORRAR este Trámite?");
}
</script>
  </head>
  <body>
	...
	<form accept-charset="UTF-8" role="form" action="ControladorBajaTramite" method="post" onSubmit="return confirmarBorrar()">
  <div class="form-group">
    <label for="nombre"></label> 
  </div>
  
  <div class="form-group">
    <label for="exampleSelect1">Tramite</label>
