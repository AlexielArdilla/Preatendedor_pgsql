...
//empty string means no validation error
  ...
  <body>
	...
	<form accept-charset="UTF-8" role="form" name="f1" action="ControladorCambioPassword" method="post">
  <div class="form-group">
    <label for="nombre"></label> 
  </div>
  
  <div class="form-group">
    <label for="exampleSelect1">Su usuario:</label>
    
    <p style="color:red; font-weight:bolder">${ok}</p>
    
    <h2><c:out value="${elUser.user}"></c:out></h2>
    
    
  </div>
  					 <label for="exampleSelect1">Su nuevo password</label>
							<div class="form-group">
								<input class="form-control" placeholder=""
									id="password1" name="password1" type="password" required >
							</div>
					 <label for="exampleSelect1">Su nuevo password de nuevo</label>
							<div class="form-group">
								<input class="form-control" placeholder=""
